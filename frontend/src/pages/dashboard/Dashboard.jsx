            ...
            <div className="max-w-6xl mx-auto px-6 py-8">
                ...
                {showCreateForm && (
                    <div className="bg-[#161b22] border border-[#30363d] rounded-xl p-6 mb-6">
                        ...
                        <form onSubmit={handleCreateInterview} className="flex items-end gap-4">
                ...
                {isLoading ? (
                    ...
                    <div className="text-center py-20">
                        ...
                        <p className="text-[#484f58] text-sm mt-1">
                            {isInterviewer() ? 'Create your first interview above' : 'Waiting for an interview link'}
                        </p>
                    </div>
                ) : (
                                    ...
                                    <div>
                                        ...
                                        {interview.score && (
                                            <p className="text-xs text-[#8b949e] mt-0.5">
                                                Score: <span className="text-[#3fb950]">{interview.score}/10</span>
                                            </p>
                                        )}
                                    </div>
                                </div>
