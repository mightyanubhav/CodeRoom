...
const CreateQuestion = () => {
  ...
  const handleLanguageChange = (lang) => {
    ...
    // Auto-update starter code if empty or matches a template
    const isTemplate = Object.values(STARTER_CODE_TEMPLATES).some(
      (t) => form.starterCode === t,
    );
    if (!form.starterCode.trim() || isTemplate) {
      handleFormChange("starterCode", STARTER_CODE_TEMPLATES[lang]);
    }
  };
                ...
                >
                  <div className="flex items-center justify-between mb-3">
                    ...
                    <div className="flex items-center gap-3">
                      ...
                      <label className="flex items-center gap-2 cursor-pointer">
                        <div
                          onClick={() =>
                            handleTestCaseChange(i, "hidden", !tc.hidden)
                          }
                  ...
                  {tc.hidden && (
                    <p className="text-xs text-[#238636] mt-2">
                      🔒 Hidden — candidate won't see input/output, only
                      pass/fail
                    </p>
                  )}
                </div>
